...
class Pixelflut(address: String, port: Int, private val pixelBufferSize: Int = 10000) {
    ...
    /**
     * Returns the size of the pixelflut screen as a pair with width and height.
     *
     ...
     *
     * @param start The upper left corner point.
     * @param end The lower right corner point.
     * @return The pixels inside the area.
     */
    fun getPixels(start: Point, end: Point): Set<Pixel> {
